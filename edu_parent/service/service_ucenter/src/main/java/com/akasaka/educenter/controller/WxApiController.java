...
import com.akasaka.educenter.utils.ConstantWxUtils;
import com.akasaka.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String callback(String code,String state) {
        try {
            ...
            //2 拿着code请求 微信固定的地址，得到两个值access_token 和 openid
            ...
            if (member == null) { // member是空，表里没有相同微信数据，进行添加
                //3 拿着得到的access_token 和 openid， 再去请求微信提供固定的地址,获取扫码人信息
                //访问微信的资源服务器，获取用户信息
