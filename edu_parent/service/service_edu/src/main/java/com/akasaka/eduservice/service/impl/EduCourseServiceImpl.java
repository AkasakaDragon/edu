...
import com.akasaka.eduservice.entity.EduCourseDescription;
...
import com.akasaka.eduservice.mapper.EduCourseMapper;
import com.akasaka.eduservice.service.EduChapterService;
import com.akasaka.eduservice.service.EduCourseDescriptionService;
import com.akasaka.eduservice.service.EduCourseService;
import com.akasaka.eduservice.service.EduVideoService;
import com.akasaka.servicebase.exceptionhandler.GuliException;
...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements EduCourseService {
    ...
    public Map<String, Object> getCourseFrontList(Page<EduCourse> pageParam, CourseFrontVo courseFrontVo) {
        ...
        // 判断条件值是否为空，不为空拼接
        if (!StringUtils.isEmpty(courseFrontVo.getSubjectParentId())){// 判断一级id是否存在
            wrapper.eq("subject_parent_id",courseFrontVo.getSubjectParentId());
        }
        if (!StringUtils.isEmpty(courseFrontVo.getSubjectId())){// 判断二级id是否存在
